...
import static br.com.jota.entities.BoardTemplate.BOARD_TEMPLATE;
...
public class Main {
    ...
    private final static Integer BOARD_LIMIT = 9;
    ...
    private static void inputNumber() {
        ...
        var value = runUntiGetValidNumber(1, 8);
    ...
    private static void showGamesStatus() {
        if (Objects.isNull(board)) {
            System.out.println("O jogo ainda não foi iniciado");
            return;
        }

        System.out.printf("O jogo atualmente o jogo se encontra no status %s\n", board.getStatus());
    ...
    private static Integer runUntiGetValidNumber(final Integer min, final Integer max) {
